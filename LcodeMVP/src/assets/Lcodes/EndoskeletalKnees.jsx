...
const EndoskeletalKnees = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5710' && lCode.hcpcs <= 'L5780') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Exoskeletal Knee-Shin Systems L5710-L5780</Typography>
...
export default EndoskeletalKnees;