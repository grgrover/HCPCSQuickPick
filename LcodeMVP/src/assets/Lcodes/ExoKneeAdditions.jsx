...
const EndoKneeAdditions = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5810' && lCode.hcpcs <= 'L5966') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Endoskeletal Knee or Hip Additions</Typography>
...
export default EndoKneeAdditions;