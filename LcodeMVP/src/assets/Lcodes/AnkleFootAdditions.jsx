...
const AnkleFootAdditions = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5968' && lCode.hcpcs <= 'L5999') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Ankle and/or Foot Additions L5968-L5999</Typography>
...
export default AnkleFootAdditions;