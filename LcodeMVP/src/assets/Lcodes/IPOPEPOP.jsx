...
const IPOPEPOP = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5400' && lCode.hcpcs <= 'L5505') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Prosthetic Fitting, Immediate/Early Postsurgical L5400-L5505</Typography>
