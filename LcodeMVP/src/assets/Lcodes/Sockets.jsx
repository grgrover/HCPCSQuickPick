...
const Sockets = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5629' && lCode.hcpcs <= 'L5653') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Various Prosthetic Sockets L5629-L5653</Typography>
        {currentCodes.map((lCode, index) => (
          <FormControl variant="standard" sx={{ m: 1, width: '85%', color: 'black'}} key={index}>
