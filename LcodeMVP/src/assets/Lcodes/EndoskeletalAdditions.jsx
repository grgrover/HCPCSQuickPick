...
const EndoskeletalAdditions = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5610' && lCode.hcpcs <= 'L5617') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Endoskeletal Additions L5610-L5617</Typography>
...
export default EndoskeletalAdditions;