...
const ReplacementSockets = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5700' && lCode.hcpcs <= 'L5703') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Replacement Sockets L5700-L5703</Typography>
...
export default ReplacementSockets;