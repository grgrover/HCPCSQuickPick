...
const TestSocketAdditions = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5618' && lCode.hcpcs <= 'L5628') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Test Socket Additions L5618-L5628</Typography>
...
export default TestSocketAdditions;