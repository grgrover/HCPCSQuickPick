...
const PartialFoot = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5000' && lCode.hcpcs <= 'L5020') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Partial Foot L5000-L5020</Typography>
