...
const GasketSocks = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs === 'L7600' || lCode.hcpcs === 'L7700' || (lCode.hcpcs >= 'L8400' && lCode.hcpcs <= 'L8485')) {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Prosthetic Soft Goods</Typography>
