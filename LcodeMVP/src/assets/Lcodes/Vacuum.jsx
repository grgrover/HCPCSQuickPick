...
const Vacuum = ({ lCodes, control }) => {
  ...
  lCodes.forEach(lCode => {
    if (lCode.hcpcs >= 'L5781' && lCode.hcpcs <= 'L5782') {
  ...
  return (
    <>
      <Stack spacing={1} direction="column" container="true" padding="2%" justifyContent="start" alignItems="center" width="100%">
        <Typography variant="h6" color="black">Vacuum Pumps, Other Additions L5781-L5782</Typography>
